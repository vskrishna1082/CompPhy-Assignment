...
const int l_size = 9, J = 1, niter = 50000;
...
int main()
{
    ...
    outfile_energy_rand.open("data/Q6.2_E_T-3.9_init_rand.dat");
    ...
    outfile_mag_rand.open("data/Q6.2_M_T-3.9_init_rand.dat");
