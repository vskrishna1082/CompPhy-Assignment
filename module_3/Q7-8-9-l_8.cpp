...
const int l_size = 8, J = 1, niter = 1010000;
...
int main()
{
    ...
    energyfile.open("data/Q7-8-9-Energy_Avg_l_8.dat");
    magfile.open("data/Q7-8-9-Mag_Avg_l_8.dat");
    magmodfile.open("data/Q7-8-9-Mag_Mod_Avg_l_8.dat");
    for (int i = 0; i < n_T; i++)
    {
