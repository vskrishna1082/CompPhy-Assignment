...
print()
print(Exp7_M[0])
# plt.plot(T, chi7, '--o', label="L = 7")
# plt.plot(T, chi8, '--o', label="L = 8")
# plt.plot(T, chi9, '--o', label="L = 9")
# plt.plot(T, cv7, '--o', label="L = 7")
# plt.plot(T, cv8, '--o', label="L = 8")
# plt.plot(T, cv9, '--o', label="L = 9")
...
# plt.plot(T, Exp7_M,'--o', label="L = 7")
# plt.plot(T, Exp8_M,'--o', label="L = 8")
# plt.plot(T, Exp9_M,'--o', label="L = 9")
# plt.plot(T, Exp7_modM,'--o', label="L = 7")
# plt.plot(T, Exp8_modM,'--o', label="L = 8")
# plt.plot(T, Exp9_modM,'--o', label="L = 9")
# plt.xlabel("Temperature")
# plt.ylabel("M/N")
# plt.legend()
...
# plt.plot(T, Exp7_E,'--o', label="L = 7")
# plt.plot(T, Exp8_E,'--o', label="L = 8")
# plt.plot(T, Exp9_E,'--o', label="L = 9")
# plt.xlabel("Temperature")
# plt.ylabel("E/N")
# plt.legend()
